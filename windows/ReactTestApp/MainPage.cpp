...
namespace winrt::ReactTestApp::implementation
{
    ...
    void MainPage::Reload(Windows::Foundation::IInspectable const &,
    ...
    void MainPage::InitializeDebugMenu()
    {
        ...
        BreakOnFirstLineMenuItem().Text(
            reactInstance_.BreakOnFirstLine() ? kDisableBreakOnFirstLine : kEnableBreakOnFirstLine);
